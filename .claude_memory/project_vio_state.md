...
1. Confirm circle_flight actually arms (check PX4 params: COM_RCL_EXCEPT=4, NAV_RCL_ACT=0)
2. Test step9 MSCKF DURING actual flight (not just sitting on ground)
3. If |b_a| still zero during flight → investigate H matrix structure for bias observability
4. Once step9 works, compare step10 multicam vs step9 mono on same flight
